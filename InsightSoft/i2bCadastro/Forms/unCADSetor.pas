...
uses
  ...
  dxGDIPlusClasses, cxImage, Vcl.ExtCtrls, unFramePai, unFrameSetor, cxButtonEdit, Datasnap.DBClient;

type
  TfrmCADSetor = class(TfrmCadastro)
    FrameSetor: TFrameSetor;
    cxGridDBidsetor: TcxGridDBColumn;
