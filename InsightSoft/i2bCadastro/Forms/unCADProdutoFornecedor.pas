...
uses
  ...
  unFrameProdutoFornecedor;

type
  TfrmCADProdutoFornecedor = class(TfrmCadastro)
    FrameProdutoFornecedor: TFrameProdutoFornecedor;
    cxGridDBidprodutofornecedor: TcxGridDBColumn;
    cxGridDBcodigoprodutofornecedor: TcxGridDBColumn;
    cxGridDBidproduto: TcxGridDBColumn;
    cxGridDBdataultimacompra: TcxGridDBColumn;
    cxGridDBprecoultimacompra: TcxGridDBColumn;
  private
