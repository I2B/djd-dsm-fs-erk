object ServerMethods: TServerMethods
  ...
  object qryRegraFiscal: TFDQuery
    ...
    SQL.Strings = (
      ...
      'tipoOperacao.descricao as tipoOperacaoDescricao, '
    ...
    object qryRegraFiscalpjicmscst: TIntegerField
      FieldName = 'pjicmscst'
      Origin = 'pjicmscst'
    end
    ...
    object qryRegraFiscalobservacao2: TWideMemoField
      AutoGenerateValue = arDefault
      FieldName = 'observacao'
      Origin = 'observacao'
      ProviderFlags = []
    ...
    object qryRegraFiscalestadonome: TWideStringField
      AutoGenerateValue = arDefault
      FieldName = 'estadonome'
      Origin = 'estadonome'
      ProviderFlags = []
