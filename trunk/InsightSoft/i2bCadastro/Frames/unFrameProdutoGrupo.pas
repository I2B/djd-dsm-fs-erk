...
uses
  ...
  Data.DB, dxLayoutContainer, dxLayoutControl, cxContainer, cxEdit, dxLayoutcxEditAdapters, cxMemo, cxDBEdit, cxTextEdit;

type
  TFrameProdutoGrupo = class(TFramePai)
    edtProdutoGrupoNome: TcxDBTextEdit;
    dxLayoutControlItem1: TdxLayoutItem;
    edtProdutoGrupoDescricao: TcxDBMemo;
