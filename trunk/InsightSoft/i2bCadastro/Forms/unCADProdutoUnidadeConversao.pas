unit unCADProdutoUnidadeConversao;
...
type
  TfrmCADProdutoUnidadeConversao = class(TfrmCadastro)
    ...
    cxGridDBidprodutounidadeconversao: TcxGridDBColumn;
    ...
    cxGridDBfatorconversao: TcxGridDBColumn;
    cxGridDBprodutonome: TcxGridDBColumn;
    cxGridDBunidadesigla: TcxGridDBColumn;
  private
...
var
  frmCADProdutoUnidadeConversao: TfrmCADProdutoUnidadeConversao;
