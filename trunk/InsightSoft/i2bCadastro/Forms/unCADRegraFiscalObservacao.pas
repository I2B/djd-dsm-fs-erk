unit unCADRegraFiscalObservacao;
...
uses
  ...
  dxGDIPlusClasses, cxImage, Vcl.ExtCtrls, unFramePai, unFrameRegraFiscalObservacao, cxButtonEdit, Datasnap.DBClient;

type
  TfrmCADRegraFiscalObservacao = class(TfrmCadastro)
    cxGridDBidregrafiscalobservacao: TcxGridDBColumn;
    cxGridDBobservacao: TcxGridDBColumn;
    FrameRegraFiscalObservacao: TFrameRegraFiscalObservacao;
  private
...
var
  frmCADRegraFiscalObservacao: TfrmCADRegraFiscalObservacao;
